...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Common Profile Param</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.khronos.collada.ColladaPackage#getCommonProfileParam()
 * @model extendedMetaData="name='Common_profile_param'"
 * @generated
 */
public enum CommonProfileParam implements Enumerator {
	/**
	...
	/**
	 * The '<em><b>DOUBLESIDED</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #DOUBLESIDED_VALUE
	 * @generated
	 * @ordered
	 */
	DOUBLESIDED(3, "DOUBLESIDED", "DOUBLE_SIDED"),
	...
	/**
	 * The '<em><b>DOUBLESIDED</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>DOUBLESIDED</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #DOUBLESIDED
	 * @model literal="DOUBLE_SIDED"
	 * @generated
	 * @ordered
	 */
	public static final int DOUBLESIDED_VALUE = 3;
	 ...
	 * @ordered
	 */
	public static final int Y_VALUE = 15;
	...
	/**
	 * An array of all the '<em><b>Common Profile Param</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final CommonProfileParam[] VALUES_ARRAY =
		new CommonProfileParam[] {
			A,
			ANGLE,
			B,
			DOUBLESIDED,
	...
	/**
	 * A public read-only list of all the '<em><b>Common Profile Param</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<CommonProfileParam> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Common Profile Param</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static CommonProfileParam get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CommonProfileParam result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Common Profile Param</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static CommonProfileParam getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CommonProfileParam result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Common Profile Param</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static CommonProfileParam get(int value) {
		switch (value) {
			case A_VALUE: return A;
			case ANGLE_VALUE: return ANGLE;
			case B_VALUE: return B;
			case DOUBLESIDED_VALUE: return DOUBLESIDED;
	 ...
	 * @generated
	 */
	private CommonProfileParam(int value, String name, String literal) {
		this.value = value;
		this.name = name;
