 ...
 *   <li>{@link org.khronos.collada.impl.SceneTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SceneTypeImpl extends EObjectImpl implements SceneType {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.SCENE_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ColladaPackage.SCENE_TYPE__EXTRA:
				return getExtra();
			case ColladaPackage.SCENE_TYPE__NAME:
				return getName();
		}
